package com.example.designpattern.schedule.generator.controller;

import com.example.designpattern.schedule.generator.model.CronExpressReq;
import com.example.designpattern.schedule.generator.service.ICronService;
import com.example.designpattern.schedule.generator.utils.CronRegExp;
...
@RestController
@RequestMapping("/cron")
public class CronExpressController {
    @Autowired
    private ICronService cronService;

    @PostMapping("/minutes")
    public ResponseEntity<String> cronMinutes(@RequestBody CronExpressReq cronExpReq) {
    ...
    @PostMapping("/hourly")
    public ResponseEntity<String> cronHourly(@RequestBody CronExpressReq cronExpReq) {
    ...
    @PostMapping("/daily")
    public ResponseEntity<String> cronDaily(@RequestBody CronExpressReq cronExpReq) {
        String time=cronExpReq.getTime();
        String type=cronExpReq.getType();
        if(time!=null) {
            boolean  validTime=CronRegExp.isValidTime(time);
    ...
    @PostMapping("/weekly")
    public ResponseEntity<String> cronWeekly(@RequestBody CronExpressReq cronExpReq) {
    ...
    @PostMapping("/monthly")
    public ResponseEntity<String> cronMonthly(@RequestBody CronExpressReq cronExpReq) {
    ...
    @PostMapping("/yearly")
    public ResponseEntity<String> cronYearly(@RequestBody CronExpressReq cronExpReq) {
