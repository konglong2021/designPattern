...
import com.example.designpattern.schedule.generator.utils.Conversion;
import com.example.designpattern.schedule.generator.utils.GenerateExp;
import org.springframework.stereotype.Service;

@Service
public class CronServiceImpl implements ICronService{
    @Override
    public String cronMinutesExp(Long minutes) {
        String mintVal = minutes.toString();
        return GenerateExp.generateCronExpression("0","0/"+mintVal,"*","1/1","*","?","*");
    }

    @Override
    public String cronHourlyExp(Long hourly) {
        String hourVal = hourly.toString();
    ...
    @Override
    public String cronEveryWeekDayExp(String weeklyTime) {
